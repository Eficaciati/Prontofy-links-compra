...
const floatingItems = [
  { label: "Prontuario eletronico", Icon: FileText },
  { label: "Agenda inteligente", Icon: CalendarCheck },
  { label: "Atendimento medico", Icon: Stethoscope },
...
const AudienceSection = () => (
  <section className="relative min-h-[72vh] overflow-hidden bg-[#050709] text-white sm:min-h-[78vh] lg:min-h-screen">
    <img
      ...
      alt="Consultorio medico organizado com tecnologia Prontofy"
      className="absolute inset-0 h-full w-full object-cover object-[42%_50%] md:object-[76%_50%] lg:object-center"
    />
    <div className="absolute inset-0 bg-black/48" />
    <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(5,7,9,0.12)_0%,rgba(5,7,9,0.18)_44%,rgba(5,7,9,0.76)_100%)]" />
    ...
    <div className="absolute left-5 top-8 z-10 max-w-[520px] sm:left-8 sm:top-10 sm:max-w-[580px] lg:left-12 lg:top-14 lg:max-w-[660px] xl:left-16">
      <p className="font-sans text-[clamp(2rem,4vw,4.55rem)] font-semibold leading-[1.04] tracking-normal text-white drop-shadow-[0_18px_42px_rgba(0,0,0,0.52)]">
        Para medicos que buscam um nivel a mais de sofisticacao em seus consultorios
      </p>
    </div>
    ...
    <div className="absolute inset-x-0 bottom-6 z-30 flex justify-center px-5 sm:bottom-8 lg:bottom-14">
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="inline-flex w-full max-w-[340px] items-center justify-center gap-3 rounded-full bg-[#1CC88A] px-6 py-4 text-center text-sm font-extrabold uppercase tracking-wide text-[#04110b] shadow-[0_18px_52px_rgba(28,200,138,0.34)] transition hover:bg-[#35df91] sm:w-auto sm:max-w-none"
      >
        Agendar uma apresentacao
