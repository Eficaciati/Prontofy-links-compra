  ...
  return (
    <section className="relative overflow-hidden bg-[#082034] px-0 py-0 text-white">
      <div className="relative min-h-[620px] overflow-hidden bg-black sm:min-h-[680px] lg:min-h-[760px]">
        ...
        <div className="relative z-10 mx-auto flex min-h-[620px] max-w-7xl items-end px-5 py-12 sm:min-h-[680px] sm:px-8 sm:py-16 lg:min-h-[760px] lg:px-10 lg:py-20">
          <div className="max-w-2xl">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-300 sm:text-sm">IA no atendimento</p>
            <h2 className="mt-4 text-[clamp(36px,4.4vw,64px)] font-extrabold leading-[0.98] text-white drop-shadow-[0_14px_40px_rgba(0,0,0,0.55)]">
              Agenda, prontuário e WhatsApp trabalhando juntos.
            </h2>
            <p className="mt-5 max-w-xl text-base leading-7 text-white/76 drop-shadow-[0_10px_26px_rgba(0,0,0,0.58)] sm:text-lg sm:leading-8">
